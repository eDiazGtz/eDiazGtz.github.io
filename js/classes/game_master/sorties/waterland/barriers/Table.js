class Table extends MapPlaceDoor {
    ...
    canPlayerPass(candidateMapSquare) {
        ...
        if (this.point.x === 36 && this.point.y === 5) {
            ...
            this.eventListener.trigger( 
                ...
                new DialogObject( 
                    ...
                    new ScriptLine("You find a note on the table among the varous things. It reads: 'herfyvmxi'")
                )
            )
            ...
            this.eventListener.trigger( 
                ...
                new DialogObject( 
                    DialogObject.DIALOG_TYPES.ONE_OFF, 
                    new ScriptLine("You find a note on the table among the varous things. It reads: 'a = q'")
                ),
            )
            ...
            this.eventListener.trigger( 
                ...
                new DialogObject( 
                    DialogObject.DIALOG_TYPES.ONE_OFF, 
                    new ScriptLine("You find a note on the table among the varous things. It reads: 'Use E for start'")
                ),
            )
                ...
                if ( this._finalTable === false ) {
                    ...
                    this.eventListener.trigger(
                        ...
                        new DialogObject(
                            ...
                            this._sortie.getScript("final_table") //_sortie not defined. Need to get from quest? mfw
                            )
                        )
