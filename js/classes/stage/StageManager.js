class StageManager{
    ...
    constructor() {
        ...
        document.addEventListener(StageManager.EVENTS.DISPLAY_LESSON, (e) => 
            this._setAct(StageManager.ACTS.LESSONS, "", e.detail));
    ...
    _setAct = (act, scene, data) => {
        ...
        switch(act) {
            ...
            case StageManager.ACTS.LESSONS:
                this.troupe = "big_screen";
                this._lessonsComponent.buildComponent(data);
                break;
            ...
            case StageManager.ACTS.STORYTELLER:
                this.troupe = "big_screen";
                this._storyTeller.scene = scene;
                this._storyTeller.buildComponent(data);
                break;
        }
    }
