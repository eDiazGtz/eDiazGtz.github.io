    ...
    _buildSortieMap = () => {
        ...
        this._stage.querySelectorAll(".map_square__inner").forEach(el => {
            ...
            el.addEventListener("mouseover", () => {
                ...
                let HTML = el.id;
                if ( mapSquare.place !== null ) HTML += ` | ${mapSquare.place.name}`;
                if ( mapSquare.item !== null ) HTML += ` | ${mapSquare.item.name}`;
                if ( mapSquare.barrier !== null ) HTML += ` | ${mapSquare.barrier._name}`;
                if ( mapSquare.character !== null ) HTML += ` | ${mapSquare.character.name}`;
